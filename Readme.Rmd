...
*  **ggplot2** functions are sorted in the following order, based on the **ggplot2** template (see cheatsheet): 
...
* Neither **formatR** nor **styler** change the order of the **ggplot2** functions.
